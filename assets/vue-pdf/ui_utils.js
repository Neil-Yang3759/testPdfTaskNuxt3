...
const MAX_AUTO_SCALE = isMobile === true ? 2.0 : 4.0
...
function scrollIntoView(element, spot, scrollMatches = false) {
  ...
  const needScroll = parent.scrollTop !== offsetY - 10
  parent.scrollTop = offsetY - 10
  return needScroll
}
...
function apiPageModeToSidebarView(mode) {
  ...
  return SidebarView.THUMBS // Default value.
}

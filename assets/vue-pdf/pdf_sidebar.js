...
import { RenderingStates, SidebarView } from './ui_utils.js'
/**
 ...
 * @property {HTMLDivElement} rightDrawerContainer - The outer container
 ...
 * @property {HTMLDivElement} selectionView - The container in which
 *   the selections is placed.
...
class PDFSidebar {
  ...
  constructor({ elements, pdfViewer, pdfThumbnailViewer, eventBus }) {
    ...
    this.rightDrawerContainer = elements.rightDrawerContainer
    this.viewerContainer = elements.viewerContainer

    this.thumbnailView = elements.thumbnailView
    this.selectionView = elements.selectionView
    this.multifileView = elements.multifileView
  ...
  switchView(view, forceOpen = false) {
    ...
    const isSelection = view === SidebarView.SELECTION
    // const isOutline = view === SidebarView.OUTLINE
    // const isAttachments = view === SidebarView.ATTACHMENTS
    // const isLayers = view === SidebarView.LAYERS
    ...
    this.selectionView.classList.toggle('hidden', !isSelection)
    if (this.multifileView) {
      this.multifileView.classList.toggle('hidden', !isThumbs)
    }
  ...
  open() {
    ...
    this.isOpen = true
    this.eventBus.dispatch('toggleSidebar', {
      source: this,
      on: true,
    })
